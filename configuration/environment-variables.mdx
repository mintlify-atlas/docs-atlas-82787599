...
<ParamField path="PUID" type="integer">
  The User ID that should own the mounted files. Used in Docker to match file permissions with your host system.
  
  To find your user ID, run: `id -u`
  
  This helps ensure your media server can access the files created by TorBox Media Center.
</ParamField>

<ParamField path="PGID" type="integer">
  The Group ID that should own the mounted files. Used in Docker to match file permissions with your host system.
  
  To find your group ID, run: `id -g`
